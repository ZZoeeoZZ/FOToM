...
maddpgFile = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/maddpg1.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_maddpg.append((float(maddpgData[i][1])+float(maddpgData[i][2])+float(maddpgData[i][3])+float(maddpgData[i][3]))) # 将第二列数据从第二行读取到最后一行赋给列表

sns.lineplot(x=x_maddpg, y=y_maddpg, palette=palette[0], label='MADDPG')
# for i in range(1, length_zu):  # 从第二行开始读取
...
ddpgFile = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/ddpg1.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_ddpg.append((float(ddpgData[i][1])+float(ddpgData[i][2])+float(ddpgData[i][3])+float(ddpgData[i][3]))) # 将第二列数据从第二行读取到最后一行赋给列表

ddpgFile = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/ddpg2.csv')  # 打开csv文件
ddpgReader = csv.reader(ddpgFile)  # 读取csv文件
ddpgData = list(ddpgReader)  # csv数据转换为列表
...
ddpgFile = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/ddpg3.csv')  # 打开csv文件
ddpgReader = csv.reader(ddpgFile)  # 读取csv文件
ddpgData = list(ddpgReader)  # csv数据转换为列表
...
#     x_ddpg.append(int(ddpgData[i][0]))  # 将第一列数据从第二行读取到最后一行赋给列表x
#     y_ddpg.append(float(ddpgData[i][1])+float(ddpgData[i][2])+float(ddpgData[i][3])+float(ddpgData[i][3]))  # 将第二列数据从第二行读取到最后一行赋给列表
sns.lineplot(x=x_ddpg, y=y_ddpg, palette=palette[1], label='DDPG')

x_snn = list()
y_snn = list()

snn1File = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/snn1.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_snn.append(float(snn1Data[i][5]) )  # 将第二列数据从第二行读取到最后一行赋给列表

snn2File = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/snn2.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_snn.append(float(snn2Data[i][5]) )  # 将第二列数据从第二行读取到最后一行赋给列表

snn3File = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/snn3.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_snn.append(float(snn3Data[i][5]) )  # 将第二列数据从第二行读取到最后一行赋给列表

sns.lineplot(x=x_snn, y=y_snn, palette=palette[2], label='SNN')


x_tom = list()
y_tom = list()

tom1File = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/tom1.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_tom.append(float(tom1Data[i][5]) )  # 将第二列数据从第二行读取到最后一行赋给列表

tom2File = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/tom2.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_tom.append(float(tom2Data[i][5]))  # 将第二列数据从第二行读取到最后一行赋给列表

# tom3File = open('/home/zhaozhuoya/maddpg-pytorch/results/tag/logs/tom3.csv')  # 打开csv文件
...
#     y_tom.append(float(tom3Data[i][5]))  # 将第二列数据从第二行读取到最后一行赋给列表

sns.lineplot(x=x_tom, y=y_tom, palette=palette[3], label='ToM')
