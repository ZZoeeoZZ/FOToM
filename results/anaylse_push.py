...
maddpgFile = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/maddpg.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_maddpg.append((float(maddpgData[i][2]) + float(maddpgData[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表
...
ddpgFile = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/ddpg.csv')  # 打开csv文件
...
snn1File = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/snn1.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_snn.append((float(snn1Data[i][2]) + float(snn1Data[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表

snn2File = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/snn2.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_snn.append((float(snn2Data[i][2]) + float(snn2Data[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表

snn3File = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/snn3.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_snn.append((float(snn3Data[i][2]) + float(snn3Data[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表
...
tom1File = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/tom1.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_tom.append((float(tom1Data[i][2]) + float(tom1Data[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表

tom2File = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/tom2.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_tom.append((float(tom2Data[i][2]) + float(tom2Data[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表

tom3File = open('/home/zhaozhuoya/maddpg-pytorch/results/push/logs/tom3.csv')  # 打开csv文件
...
for i in range(1, length_zu):  # 从第二行开始读取
    ...
    y_tom.append((float(tom3Data[i][2]) + float(tom3Data[i][1])))  # 将第二列数据从第二行读取到最后一行赋给列表
